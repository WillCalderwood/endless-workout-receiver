import{t as e}from"./shaderStore-D-XQlhUT.js";import{a as t,i as ee,n as te,r as ne,t as re}from"./logDepthDeclaration-BKcd_JEL.js";import{t as ie}from"./helperFunctions-BXbvU0Ia.js";var n=`decalFragmentDeclaration`,r=`#ifdef DECAL
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var oe={name:i,shader:a},o=`prePassDeclaration`,s=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);var se={name:o,shader:s},c=`oitDeclaration`,ce=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=ce);var le={name:c,shader:ce},l=`lightFragmentDeclaration`,u=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var ue={name:l,shader:u},d=`lightUboDeclaration`,f=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var fe={name:p,shader:m},h=`clusteredLightingFunctions`,g=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var pe={name:h,shader:g},_=`lightsFragmentFunctions`,me=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=me);var he={name:_,shader:me},v=`shadowsFragmentFunctions`,y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var ge={name:v,shader:y},b=`samplerFragmentDeclaration`,x=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var _e={name:b,shader:x},S=`fresnelFunction`,C=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=C);var ve={name:S,shader:C},w=`reflectionFunction`,T=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=T);var ye={name:w,shader:T},E=`imageProcessingDeclaration`,D=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=D);var be={name:E,shader:D},O=`imageProcessingFunctions`,xe=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=xe);var Se={name:O,shader:xe},k=`textureRepetitionFunctions`,A=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var Ce={name:k,shader:A},j=`bumpFragmentMainFunctions`,M=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var we={name:j,shader:M},N=`bumpFragmentFunctions`,P=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var Te={name:N,shader:P},F=`clipPlaneFragmentDeclaration`,I=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var Ee={name:F,shader:I},L=`fogFragmentDeclaration`,R=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var De={name:L,shader:R},z=`clipPlaneFragment`,B=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var Oe={name:z,shader:B},V=`bumpFragment`,H=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var ke={name:V,shader:H},U=`decalFragment`,W=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);var Ae={name:U,shader:W},G=`depthPrePass`,K=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=K);var je={name:G,shader:K},q=`lightFragment`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=J);var Me={name:q,shader:J},Y=`logDepthFragment`,X=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=X);var Ne={name:Y,shader:X},Z=`fogFragment`,Pe=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=Pe);var Fe={name:Z,shader:Pe},Q=`oitFragment`,Ie=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=Ie);var Le={name:Q,shader:Ie},$=`defaultPixelShader`,Re=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[$]||(e.ShadersStore[$]=Re);var ze=[ae,oe,t,ee,ne,se,le,te,ie,ue,de,fe,pe,he,ge,_e,ve,ye,be,Se,Ce,we,Te,Ee,re,De,Oe,ke,Ae,je,Me,Ne,Fe,Le];for(let t of ze)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var Be={name:$,shader:Re};export{Be as defaultPixelShader};